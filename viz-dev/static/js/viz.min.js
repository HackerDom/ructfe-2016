...
100);setTimeout(function(){C.select("#"+q+"radial").remove();a.remove()},400)},800)}))}function T(b){for(var d=[],a=0;a<b;a++)d.push({x:45*O[a][0],y:26*O[a][1]});return d}function K(b){var d="<table><td><img src='https://ructfe.org/logos/"+md5(b.name)+".png'/></td><td><div class='header-wrapper'><span class='value team-name'>",a;a=b.name;a=$("<div/>").text(a).html();return d+a+"</span></div><div><span class='header'>Place:</span> <span class='value'>"+b.place+"</span></div><div><span class='header'>Score:</span> <span class='value'>"+
