var Viz = function(infoData, startScoreboard) {
	...
	function getCoordsForTeams(count) {
		...
		for (var i=0; i<count; i++) {
			coords.push({"x": allCoords[i][0], "y":  allCoords[i][1]});
		}
		return coords;
	}
